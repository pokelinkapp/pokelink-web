Vue.component( "Pokemon", {
  ...
  computed: {
    ...
    sex() {
      if (!this.pokemonExists || this.pokemon.isEgg) return ''
    ...
    type1() {
      if (!this.pokemonExists || this.pokemon.isEgg) { return 'rgba(255,255,255,.2)'; }
  ...
  methods: {
    ...
    getBorderColor: function() {
      ...
      if (!this.pokemonExists || this.pokemon.isEgg) { return 'white'; }
    ...
    getBgColor: function() {
      ...
      if (!this.pokemonExists || this.pokemon.isEgg) { return 'rgba(255,255,255,.5)'; }
