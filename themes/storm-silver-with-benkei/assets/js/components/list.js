...
`,
  ...
  mounted: function () {
    ...
    client.setup(settings.port, settings.currentUser+'-browser', settings.server, (username, party) => {
        ...
        fetch('https://api.pokemontcg.io/v1/cards?setCode=base1|base2|basep|ex3|pop5|pop1|pop3|xyp|col1|dp1|dp2|dp3|dp4|swsh1|swsh2|ex15&supertype=pokemon&nationalPokedexNumber=' + idList)
