...
import {V3, clientSettings, V3DataTypes, Pokemon} from 'pokelink'
...
export default defineComponent({
      ...
      <div class="card has-text-weight-bold has-text-white">
        ...
        <div class="card-content has-text-centered" v-if="typeof this.pokemon === 'object'">
          ...
          <div class="stats" v-if="!this.pokemon.isEgg">
            <div v-if="this.pokemon.exp?.level > 0">
              <span class="value">{{ this.pokemon.exp?.level }}</span>
    ...
    computed: {
        ...
        imageTag() {
            ...
            let imageTag = name + '-' + this.pokemon.translations!.english!.species
