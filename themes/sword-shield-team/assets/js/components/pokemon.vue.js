...
import { clientSettings, string2ColHex, V3, V3DataTypes } from 'pokelink';
        ...
        getPokeballBottomColor: function () {
            ...
            if (this.colorType) {
                if (this.pokemon.translations.english.types.length === 2) {
                    return V3.getTypeColor(this.pokemon.translations.english.types[1]);
                }
                return V3.getTypeColor(this.pokemon.translations.english.types[0]);
            }
            return 'white';
