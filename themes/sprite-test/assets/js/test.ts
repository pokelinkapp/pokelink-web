...
import {homeSpriteTemplate, Handlebars, Nullable, clientSettings, spriteTestInitialize, isDefined, resolveIllegalCharacters, V3, Pokemon} from 'pokelink'
import {defineComponent} from 'vue'

interface SpriteDexItem {
    species: number
    form: number
    ...
    createApp({
            ...
            <div>
              <div class="flex items-center mb-2 w-screen">
                ...
                <label class="inline-flex items-center cursor-pointer ml-2 mr-2">
                  ...
                  <span class="ms-3 text-sm font-medium text-white">Enable Shiny Sprites</span>
                </label>
        ...
        methods: {
            ...
            handleError(i: number, img: HTMLImageElement) {
                ...
                this.results[i] = 1
                V3.useFallback(img, this.entries[i])
            },
            hasValue(idx?: any){
            ...
            exampleOutput() {
                try {
                    const result = V3.getSprite(this.examplePokemon)
        ...
        watch: {
            templateText(newValue) {
                ...
                try {
                    ...
                    V3.updateSpriteTemplate(newValue)
                } catch(ex) {
                    this.hasError = true
                    this.error = ex
                }
